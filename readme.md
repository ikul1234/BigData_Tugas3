...
- Pertama membaca data dari file yang sudah di download dari file terlampir. yang dibaca hanya <br/>
  movies.csv<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/file_reader.PNG "file reader")<br>

- Dengan melakukan konfigurasi seperti ini, dengan memastikan movieID terbaca<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/file_reader_conf.jpg "file reader conf")<br>

- Dari ini kita melakukan konfigurasi di dalam node add fields untuk menambahkan userid dan timestamp.<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/add_fields.PNG "add field")<br>

- Di dalam add field terdapat workflow yang dapat menyeting userid dan timestamp<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/node_add_fields.PNG "add field")<br>

- Melakukan konfigurasi di dalam node constant value untuk menyeting timestamp dan node selanjutnya untuk menyeting 
  userid<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/node_timestamp.PNG "add field")
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/timestamp.PNG "add field")<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/node_userid.PNG "add field")
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/userid.PNG "add field")<br>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/row_splitter.PNG "add field")<br>

- Melakukan konfigurasi di dalam row splitter seperti ini<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/row_splitter_conf.PNG "add field")<br>

- Open vie node tersebut untuk melihat hasilnya<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/node_rating.PNG "add field")<br>

- Hasil rating didapati seperti ini, dengan keterangan tertera pada gambar, hasil ini sesuai dengan userid yang <br/>
  disetting<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/hasil_ratings.PNG "add field")<br>

### File Reader versi SPARK

- Memulai dengan memasang node local big data environment untuk disambung ke node spark<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/local_bigdata.PNG "add field")<br>

- Pastikan konfigurasi seperti ini<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/conf_local_bigdata.PNG "add field")<br>

- Sambungkan local environment big data dengan spark, sehingga dapat membaca file dari directory yang tertera<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/spark.PNG "add field")
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/conf_spark.jpg "add field")<br>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/partition.PNG "add field")<br>

- Pastikan memilih persen dan memilih draw randomly.<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/conf_partition.PNG "add field")<br>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/model.PNG "add field")<br>

## Evaluation

- Data yang sudah diprediksi berupa seperti ini
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/hasilprediksi.PNG "add field")<br>
...
- Dari data yang sudah di modeling dan dari proses evaluasi ini menghapus juga data NAN.setalah itu terdapat hasil<br>
 ...
 ![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/evaluation.PNG "add field")<br>
 
 - Didapati hasil evaluasi dari percobaan seperti berikut<br>
  ![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/hasil_prediksi.PNG "add field")<br>
 

## Deployment

- Workflow ini akan mendisplay 10 peringkat prediksi film rekomendasi<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/deploy.PNG " asli csv")<br/>

### konfigurasi node top 20
- Tidak lupa menjalankan file reader untuk di join dengan file prediksi<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/deploy_read.PNG " asli csv")<br/>

- Jalankan spark predictor dan akan mendapati hasil seperti ini<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/spark_deploy.PNG " asli csv")<br/>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/recom.PNG " asli csv")<br/>

- Row filter disini untuk menghapus hasil prediksi yang hasilnya NAN<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/row_predik.PNG " asli csv")<br/>

- Dan untuk mengurutkan data hasilnya dipilih ascending untuk nilai kolom prediction<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/asc.PNG " asli csv")<br/>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/best.PNG " asli csv")<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/excel.PNG " asli csv")<br/>

## Hasil Deploy
- Hasil yang didapati adalah sebagai berikut sesuai dengan arahan untuk memberi best 10 movie<br>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/hasil_done.PNG " asli csv")<br/>

## Susunan KNIME
Susunan KNIME seperti berikut
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/arsitek.PNG " asli csv")<br/>
...
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/timer.PNG " asli csv")<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/konfi.jpg " asli csv")<br/>

- Perbedaan data sebagai berikut<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/spark_time.PNG " asli csv")<br/>
![alt text](https://github.com/ikul1234/BigData_Tugas3/blob/master/picture/read_time.PNG " asli csv")<br/>
